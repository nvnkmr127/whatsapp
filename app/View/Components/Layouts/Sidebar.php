...
class Sidebar extends Component
{
    ...
    protected function mainLinks()
    {
        return [
            ...
            // Placeholders hidden for now until routes exist
            /*
            [
                'route' => 'dashboard', // TODO: social.index
                'label' => 'Social Posting',
                'icon' => 'M7 11.5V14m0-2.5v-6a1.5 1.5 0 113 0m-3 6a1.5 1.5 0 00-3 0v2a7.5 7.5 0 0015 0v-5a1.5 1.5 0 00-3 0m-6-3V11m0-5.5v-1a1.5 1.5 0 013 0v1m0 0V11m0-5.5a1.5 1.5 0 013 0v3m0 0V11'
            ],
            [
                'route' => 'dashboard', // TODO: snapbox.index
                'label' => 'SnapBox',
    ...
    protected function systemLinks()
    {
        return [
            [
            ...
            /*
            [
                'route' => 'dashboard', // TODO: ads
                'label' => 'Click Ads',
                'icon' => 'M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122'
            ],
            [
                'route' => 'dashboard', // TODO: catalogs
