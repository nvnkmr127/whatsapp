                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('settings.mobile-app') }}">
                                {{ __('Mobile App') }}
                            </x-dropdown-link>
                            ...
                            @can('manage-settings')
                                ...
                                <x-dropdown-link href="{{ route('compliance.logs') }}">
                                    {{ __('Compliance Logs') }}
                                </x-dropdown-link>

                                <x-dropdown-link href="{{ route('compliance.registry') }}">
                                    {{ __('Compliance Registry') }}
                                </x-dropdown-link>
                            @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link href="{{ route('settings.mobile-app') }}" :active="request()->routeIs('settings.mobile-app')">
                    {{ __('Mobile App') }}
                </x-responsive-nav-link>
                ...
                @can('manage-settings')
                    ...
                    <x-responsive-nav-link href="{{ route('compliance.logs') }}"
                        :active="request()->routeIs('compliance.logs')">
                        {{ __('Compliance Logs') }}
                    </x-responsive-nav-link>

                    <x-responsive-nav-link href="{{ route('compliance.registry') }}"
                        :active="request()->routeIs('compliance.registry')">
                        {{ __('Compliance Registry') }}
                    </x-responsive-nav-link>
                @endcan
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    ...
                    <x-responsive-nav-link href="{{ route('teams.whatsapp_config') }}"
                        :active="request()->routeIs('teams.whatsapp_config')">
                        {{ __('WhatsApp API') }}
                    </x-responsive-nav-link>
