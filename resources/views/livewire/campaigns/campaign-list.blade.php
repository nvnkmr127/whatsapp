        ...
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight uppercase">Broadcast <span
                        class="text-wa-green">Studio</span></h1>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        @forelse ($campaigns as $campaign)
            <div
                ...
                <div class="absolute top-6 right-6">
                    <span
                        class="px-3 py-1 text-[10px] font-black uppercase tracking-widest rounded-full 
                            @if($campaign->status === 'completed') bg-wa-green/10 text-wa-green border border-wa-green/20
                ...
                <div class="flex flex-col h-full">
                    <div class="mb-6">
                        <div class="text-xs font-black text-wa-green uppercase tracking-widest mb-1">
                            {{ $campaign->template_name }}</div>
                        <h3
        ...
        @empty
            <div
                ...
                <a href="{{ route('campaigns.create') }}"
                    class="px-8 py-3 bg-wa-green text-slate-900 font-black uppercase tracking-widest text-xs rounded-2xl shadow-xl shadow-wa-green/20 hover:scale-[1.05] transition-all">
                    Initialize Campaign
                </a>
            </div>
        @endforelse
