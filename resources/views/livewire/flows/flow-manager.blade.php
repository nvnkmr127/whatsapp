<div class="space-y-8">
        ...
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight uppercase">Smart <span
                        class="text-wa-green">Flows</span></h1>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($flows as $flow)
            <div
                class="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 shadow-xl border border-slate-50 dark:border-slate-800 hover:border-wa-green/20 transition-all group relative flex flex-col h-full">

                <div class="flex items-center justify-between mb-6">
                    <div class="p-4 bg-wa-green/10 text-wa-green rounded-2xl">
                        <svg class="w-6 h-6 text-wa-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex flex-col items-end gap-2">
                        <span
                            class="px-3 py-1 text-[10px] font-black uppercase tracking-widest rounded-full {{ $flow->status === 'PUBLISHED' ? 'bg-wa-green/10 text-wa-green' : 'bg-slate-100 text-slate-500' }}">
                            {{ $flow->status }}
                        </span>
        ...
        @empty
            <div class="col-span-full py-20 flex flex-col items-center justify-center text-center">
                ...
                <button wire:click="$toggle('showCreateModal')"
                    class="px-12 py-4 bg-wa-green text-white font-black uppercase tracking-widest text-xs rounded-2xl shadow-2xl shadow-wa-green/20 hover:scale-105 transition-all">
            ...
            <div
                ...
                <div class="p-8 pb-0 flex justify-between items-center">
                    <h2 class="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight">
                        Create <span class="text-wa-green">Flow</span>
                    </h2>
                    <button wire:click="$toggle('showCreateModal')"
                ...
                <div class="p-8 space-y-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" wire:model.defer="name" placeholder="E.g. Customer Feedback Survey"
                            class="w-full px-5 py-3 bg-slate-50 dark:bg-slate-800 border-none rounded-xl text-slate-900 dark:text-white font-bold focus:ring-2 focus:ring-wa-green/20">
                        ...
                        <label class="flex items-start gap-4 cursor-pointer group">
                            <div class="flex items-center h-6">
                                <input type="checkbox" wire:model.defer="usesDataEndpoint"
                                    class="w-5 h-5 rounded-lg border-none bg-white dark:bg-slate-700 text-wa-green focus:ring-wa-green/20 transition-all">
                            </div>
                            <div class="flex-1">
                                <span
                                    class="block text-sm font-black text-slate-900 dark:text-white uppercase tracking-wide group-hover:text-wa-green transition-colors">Use
                                    Data Endpoint</span>
                    ...
                    <div class="pt-4 flex gap-4">
                        ...
                        <button wire:click="createFlow" wire:loading.attr="disabled"
                            class="flex-[2] py-4 bg-slate-900 dark:bg-wa-green text-white dark:text-slate-900 font-black uppercase tracking-widest text-xs rounded-2xl shadow-xl shadow-slate-900/10 dark:shadow-wa-green/20 hover:scale-[1.02] active:scale-95 transition-all">
                            Create Flow
                        </button>
                    </div>
                </div>
