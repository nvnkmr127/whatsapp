                    ...
                    <div class="relative flex-1">
                        ...
                        <div class="space-y-4 mb-8">
                            ...
                            <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl">
                                ...
                                <div>
                                    <div class="text-xs font-black text-slate-400 uppercase tracking-widest">Contacts Limit</div>
                                    <div class="font-bold text-slate-900 dark:text-white">
                                        {{ number_format($plan->contact_limit ?? 1000) }} <span
                                            class="text-xs font-medium text-slate-500">contacts</span>
                                    </div>
                                </div>
                            </div>

                            <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl">
                                <div class="p-2 bg-white dark:bg-slate-800 rounded-xl text-purple-500 shadow-sm">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div>
                                    <div class="text-xs font-black text-slate-400 uppercase tracking-widest">Automation Runs</div>
                                    <div class="font-bold text-slate-900 dark:text-white">
                                        {{ number_format($plan->automation_run_limit ?? 100) }} <span
                                            class="text-xs font-medium text-slate-500">/mo</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl">
                                <div class="p-2 bg-white dark:bg-slate-800 rounded-xl text-pink-500 shadow-sm">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div>
                                    <div class="text-xs font-black text-slate-400 uppercase tracking-widest">AI Conversations</div>
                                    <div class="font-bold text-slate-900 dark:text-white">
                                        {{ number_format($plan->ai_conversation_limit ?? 50) }} <span
                                            class="text-xs font-medium text-slate-500">/mo</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex justify-between">
                                            <span class="text-xs font-bold text-slate-600 dark:text-slate-400">Contacts Limit</span>
                                        </div>
                                        <input type="number" wire:model="contact_limit" placeholder="e.g. 1000"
                                            class="w-full px-4 py-2 bg-white dark:bg-slate-800 border-none rounded-xl text-slate-900 dark:text-white font-bold focus:ring-2 focus:ring-indigo-500/20">
                                        @error('contact_limit') <span
                                            class="text-rose-500 text-[10px] uppercase font-bold">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex justify-between">
                                            <span class="text-xs font-bold text-slate-600 dark:text-slate-400">Automation Runs / Month</span>
                                        </div>
                                        <input type="number" wire:model="automation_run_limit" placeholder="e.g. 100"
                                            class="w-full px-4 py-2 bg-white dark:bg-slate-800 border-none rounded-xl text-slate-900 dark:text-white font-bold focus:ring-2 focus:ring-indigo-500/20">
                                        @error('automation_run_limit') <span
                                            class="text-rose-500 text-[10px] uppercase font-bold">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex justify-between">
                                            <span class="text-xs font-bold text-slate-600 dark:text-slate-400">AI Conversations / Month</span>
                                        </div>
                                        <input type="number" wire:model="ai_conversation_limit" placeholder="e.g. 50"
                                            class="w-full px-4 py-2 bg-white dark:bg-slate-800 border-none rounded-xl text-slate-900 dark:text-white font-bold focus:ring-2 focus:ring-indigo-500/20">
                                        @error('ai_conversation_limit') <span
                                            class="text-rose-500 text-[10px] uppercase font-bold">{{ $message }}</span>
                                        @enderror
                                    </div>
