<div>
    @if ($step === 'request')
        <!-- Request OTP Step -->
        <form wire:submit.prevent="requestOtp" x-data="{ timer: 0 }">
            <!-- Login Method Indicator -->
            <div class="mb-6">
                <div
                    class="flex items-center justify-center gap-2 py-4 px-6 bg-wa-teal/10 border-2 border-wa-teal/20 rounded-2xl animate-glow-pulse">
                    <svg class="w-6 h-6 text-wa-teal" fill="currentColor" viewBox="0 0 24 24">
                        <path
                    ...
                    <span class="text-sm font-black uppercase tracking-widest text-wa-teal">Login via WhatsApp</span>
                </div>
            </div>
