        ...
        <div class="flex items-center gap-3">
             <button wire:click="$toggle('debugMode')" 
                ...
                <div class="flex items-center gap-2">
                    <span class="w-2 h-2 rounded-full" :class="$wire.debugMode ? 'bg-amber-500 animate-pulse' : 'bg-slate-300'"></span>
                    Debug Mode
                </div>
            </button>
            ...
            <button type="button" wire:click.prevent="save"
                class="bg-wa-teal hover:bg-wa-dark text-white text-sm font-bold px-5 py-2 rounded-xl flex items-center gap-2 transition shadow-lg shadow-wa-teal/20">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- URL / Resource / Upload -->
                             <div class="space-y-4" x-show="['image', 'video', 'audio', 'file', 'webhook'].includes(selectedNode.type)">
                                ...
                                <div>
                                    <label class="block text-xs font-bold text-slate-500 uppercase mb-1">Resource URL</label>
                            ...
                            <div x-show="['text', 'interactive_button', 'interactive_list', 'user_input', 'openai', 'delay', 'image', 'video', 'audio', 'file'].includes(selectedNode.type)">
                                ...
                                <div class="relative">
                                    <textarea wire:model.blur="nodeText" wire:change="updateNodeData" rows="6" @focus="initTribute"
                                        class="mentionable w-full bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-wa-teal focus:border-wa-teal text-slate-700 dark:text-slate-200 p-4 leading-relaxed"
