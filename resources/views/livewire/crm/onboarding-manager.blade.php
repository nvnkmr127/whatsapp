<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        @foreach([
            'not_started' => ['label' => 'New Signups', 'icon' => '👤', 'desc' => 'Requesting for new WhatsApp', 'color' => 'bg-slate-100 text-slate-600'],
            'abandoned' => ['label' => 'Stalled Setup', 'icon' => '🚧', 'desc' => 'Didn\'t connect WhatsApp', 'color' => 'bg-amber-50 text-amber-600 border-amber-200'],
            'no_activity' => ['label' => 'Inactive', 'icon' => '💤', 'desc' => 'Didn\'t send 1st message', 'color' => 'bg-rose-50 text-rose-600 border-rose-200'],
            'active' => ['label' => 'Active Users', 'icon' => '🚀', 'desc' => 'Sending messages', 'color' => 'bg-emerald-50 text-emerald-600 border-emerald-200']
        ] as $key => $meta)
            <button wire:click="setFilter('{{ $key }}')" 
                ...
                <div class="flex justify-between items-start mb-4">
                    ...
                    <span class="text-2xl font-black text-slate-900">{{ $counts[$key] }}</span>
                </div>
