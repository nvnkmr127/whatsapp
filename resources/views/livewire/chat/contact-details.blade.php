                ...
                <div class="p-6 space-y-8">
                    ...
                    <section>
                        ...
                        <div
                            ...
                            @else
                                <span
                                    class="text-xs font-black text-slate-400 italic uppercase tracking-wider">Unassigned</span>
                            ...
                            @forelse($conversation->notes as $note)
                                <div
                                    ...
                                    <div class="flex items-center justify-between mb-1">
                                        <span
                                            class="text-[10px] font-black text-wa-teal uppercase">{{ $note->user->name }}</span>
                                        <span
