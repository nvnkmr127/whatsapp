...
// Web Push Notification Service Worker (Public)
...
Route::middleware([
    ...
    Route::get('/settings/ticket-integration', \App\Livewire\Settings\TicketIntegrationSettings::class)->name('settings.ticket-integration')->middleware('can:manage-settings');
